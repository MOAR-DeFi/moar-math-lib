/* eslint-disable */
export const calculateLiquidityBasicAccount = {
    "assets": [
        {
        "cTokenBalance": "8",
...
export const calculateLiquidityBasicAccountWithCOPs = {
    "assets": [
        {
            "cTokenBalance": "8",
            "storedBorrowBalance": "0",
...
export const calculateLiquidityBasicAccountWithOutdatedCOP = {
    "assets": [
        {
            "cTokenBalance": "8",
            "storedBorrowBalance": "0",
...
export const calculateLiquidityBasicAccountWithCOPsWithBorrow = {
    "assets": [
        {
            "cTokenBalance": "8",
            "storedBorrowBalance": "0",
...
export const calculateLiquidityBasicAccountWithCOPNotLocked = {
    "assets": [
        {
            "cTokenBalance": "8",
            "storedBorrowBalance": "0",
...
export const calculateLiquidityBasicAccountWithCOPMTM= {
    "assets": [
        {
            "cTokenBalance": "8",
            "storedBorrowBalance": "0",
...
export const calculateLiquidityBasicAccountMultipleCOPsMultipleBorrows = {
    "assets": [
        {
            "cTokenBalance": "8",
            "storedBorrowBalance": "0",
